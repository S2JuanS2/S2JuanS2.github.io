        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-grow justify-center items-center">
                <div className="pt-8 border-4 border-blue-900 bg-blue-950 rounded-2xl w-10/12 h-100 text-center">
                    ...
                    <p className="text-white"><TypewriterEffect text={"API alojada en un servidor gratuito."} speed={50} delay={5}></TypewriterEffect></p>
                    <h2 className="text-white font-bold underline underline-offset-2 mt-5"><TypewriterEffect text={"Leyenda"} speed={50} delay={8}></TypewriterEffect></h2>
                    <div className="flex flex-col justify-center ml-20 mt-4 space-y-2">
                        <div className="flex">
                            <img src="/images/info.png" alt="info" className="w-6 h-6"/>
                            <p className="text-white ml-2"><TypewriterEffect text={"Ayuda."} speed={50} delay={9}></TypewriterEffect></p>
                        </div>
                        <div className="flex">
                            <img src="/images/user-img.png" alt="user" className="w-6 h-6"/>
                            <p className="text-white ml-2"><TypewriterEffect text={"Repositorio del proyecto."} speed={50} delay={10}></TypewriterEffect></p>
                        </div>
                    </div>
                    {showButton && (
                        <div className="mt-9">
