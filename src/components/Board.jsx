        ...
        <div className="flex justify-between ml-45 mr-45 mt-8 mb-50">
            ...
            <div className="mt-10">
                ...
                <div className="flex flex-row justify-between">
                    <img src="/images/load.png" alt="load" className="w-8 h-8 ml-2 mt-2 cursor-pointer"/>
                    <h3 className='mt-3 text-white font-medium'>Ingresar</h3>
                    <img src="/images/load.png" alt="load" className="w-8 h-8 mr-2 mt-2 cursor-pointer transform rotate-180"/>
                </div>
            </div>
