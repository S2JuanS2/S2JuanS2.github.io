            ...
            <div className="flex justify-between h-30 pb-36">
                <div className="mt-9 ml-45">
                    <div className="flex flex-row">
                        <img src="/src/assets/Header/home-img.png" alt="" className="w-8 h-8 mr-4 transition-transform duration-300 hover:scale-120 cursor-pointer"/>
                ...
                <div className="flex justify-end mt-9 mr-45">
                    <img src="/src/assets/Header/config-sec-img.png" alt=""  className="w-10 h-10 mr-4 transition-transform duration-300 hover:scale-120 cursor-pointer"/>
                    <div className="flex flex-col items-center">
                        <img src="/src/assets/Header/user-img.png" alt="" className="w-16 h-16  transition-transform duration-300 hover:scale-120 cursor-pointer"/>
